    ...
    def __str__(self) :
        ...
        chaine = " "*60+"\n"+"*"*60+"\n\n"+"   Le numéro de l'étudiant : "+self.NumEtud+"\n"+\
                ...
                "   Le programme de l'étudiant : "+self.Programme+"\n"+\
                 ...
                 "   Le numéro du casier : " + self.casier.Num_casier + "\n" + \
                 "   Le grandeur du casier : " + self.casier.grandeur + "\n" + \
                 "   Le bloc du casier : " + self.casier.bloc + "\n" + \
                 "   Le prix du casier : " + self.casier.PrixCasier + "\n" + \
                 "\n"+"*"*60
        return chaine
